...
export const profile = {
  ...
  whatsappText: "Hey Harshita! Saw your site 🎀 You are so cool & stunning, let's talk fashion & journalism!",
  motto: "Unapologetically gorgeous, effortlessly cool, serving looks & romanticizing every chapter ✨",
};

/**
 * Hero turntable frames (all real photos of Harshita!).
 */
export const turntableFrames = [
  "/harshita/harshita1.jpg",
  "/harshita/harshita2.png",
  "/harshita/harshita3.jpg",
  "/harshita/harshita4.jpg",
  "/harshita/harshita5.jpg",
  "/harshita/harshita1.jpg",
  "/harshita/harshita2.png",
  "/harshita/harshita3.jpg",
  "/harshita/harshita4.jpg",
...
export const aboutPortrait = "/harshita/harshita4.jpg";

/**
 * All photos for the dedicated photo gallery section
 */
export const photoGallery = [
  { src: "/harshita/harshita1.jpg", title: "Beach Night Vibe", caption: "Night beach aesthetics & striped fit 🔥" },
  { src: "/harshita/harshita2.png", title: "Scenic Highway Pose", caption: "Sunlit mountain road views & classic denim 🌲" },
  { src: "/harshita/harshita3.jpg", title: "Flower Bouquet Walk", caption: "Fresh flowers & romantic street walks 🌹" },
  { src: "/harshita/harshita4.jpg", title: "Graphic Wall Moment", caption: "Bold art aesthetic & red top styling ✨" },
  { src: "/harshita/harshita5.jpg", title: "Night Courtyard Fit Check", caption: "Fairy light courtyard & converse fit check 💫" },
];
...
export const timeline = [
  { year: "2024", title: "Discovered Fashion & Media", line: "Fell in love with fashion magazines, editorial styling & media.", photo: "/harshita/harshita3.jpg" },
  { year: "2025", title: "Styling & Feature Writing", line: "Curating daily looks, writing fashion pieces & refining my aesthetic.", photo: "/harshita/harshita2.png" },
  { year: "2026", title: "Prep & Main Character Vibes", line: "Living my best life, building my fashion portfolio & prepping for college.", photo: "/harshita/harshita1.jpg" },
  { year: "2027", title: "College Bound (BJMC) 🎓", line: "Entering college in 2027 as a BJMC major focusing on Fashion Journalism!", photo: "/harshita/harshita5.jpg" },
  { year: "Now", title: "Living My Best Life ✨", line: "Looking stunning, styling fits, texting guys, rizzing & being the coolest girl around 🔥", photo: "/harshita/harshita4.jpg" },
];
